...
# ============================================================================
# IMPORTANT NOTE FOR HQ CAMERA (IMX477)
# ============================================================================
# The Raspberry Pi High Quality Camera (12MP) requires a C-mount or CS-mount 
# lens to be attached. 
#
# IF YOU SEE A PINK/RED UNIFORM IMAGE:
# This is normal behavior when NO LENS is attached. The sensor is just seeing 
# diffuse ambient light. You MUST attach a lens to see a proper image.
# ============================================================================
...
class CameraStream:
    ...
    def start(self):
        try:
            ...
            # We explicitly try to set a configuration suitable for the HQ camera
            # though picamera2 usually auto-detects.
            ...
            # Auto-focus/Auto-exposure is handled automatically by libcamera
            # but without a lens, the algorithms will fail to find focus/contrast
            # resulting in the flat color you see.
    ...
    <html>
        <head>
            ...
            <style>
                ...
                .warning { color: #ff4444; font-weight: bold; margin: 20px; padding: 10px; border: 1px solid #ff4444; }
            </style>
        </head>
        <body>
            ...
            <div class="warning">
                NOTE: If the image is PINK/UNIFORM, you are missing a LENS.<br>
                The HQ Camera requires a C or CS mount lens to function.
            </div>
...
if __name__ == "__main__":
    # Initialize cameras
    # Assuming the HQ camera is the primary one (0) or secondary (1)
    # You can adjust this range if you have multiple cameras
    cameras[0] = CameraStream(0)
    # cameras[1] = CameraStream(1) # Uncomment if you have a second camera
    ...
    ip = get_ip_address()
    print(f"\n\n=================================================")
    print(f"  HQ CAMERA STREAMING STARTED")
    print(f"  Open this link in your browser:")
    print(f"  http://{ip}:5000")
    print(f"  NOTE: Ensure a LENS is attached!")
    print(f"=================================================\n\n")
